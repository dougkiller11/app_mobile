...
class EntreePage extends StatelessWidget {
  ...
  void _addToCart(BuildContext context, Product entree) {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text('${entree.name} ajoutée au panier'),
  ...
  Widget _buildProductImage(Product product) {
    ...
    if (product.imageUrl.isEmpty || product.imageUrl.startsWith('assets')) {
      return Image.asset(
        ...
        fit: BoxFit.cover,
        errorBuilder: (ctx, err, _) => const Icon(Icons.restaurant, size: 50, color: Colors.white),
      );
    }
            ...
            children: [
              ...
              Expanded(
                child: FutureBuilder<List<Product>>(
                  future: ProductService.getProducts('entree'),
                  builder: (context, snapshot) {
                    ...
                    if (products.isEmpty) {
                      return const Center(child: Text('Aucune entrée disponible'));
                    }
