...
class PizzaPage extends StatelessWidget {
  ...
  void _addToCart(BuildContext context, Product pizza) {
  ...
  Widget _buildProductImage(Product product) {
    ...
    if (product.imageUrl.startsWith('/data/') || product.imageUrl.startsWith('/storage/')) {
      return Image.file(
        ...
        errorBuilder: (ctx, err, _) {
          ...
          return const Icon(Icons.local_pizza, size: 50, color: Colors.white);
        },
      );
    }
    ...
    if (product.imageUrl.isEmpty || product.imageUrl.startsWith('assets')) {
      return Image.asset(
        ...
        fit: BoxFit.cover,
        errorBuilder: (ctx, err, _) => const Icon(Icons.local_pizza, size: 50, color: Colors.white),
      );
    }
            ...
            children: [
              ...
              Expanded(
                child: FutureBuilder<List<Product>>(
                  future: ProductService.getProducts('pizza'),
                  builder: (context, snapshot) {
                    ...
                    if (products.isEmpty) {
                      return const Center(child: Text('Aucune pizza disponible'));
                    }
