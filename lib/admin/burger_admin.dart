...
class _BurgerAdminPageState extends State<BurgerAdminPage> {
  ...
  Future<void> _loadProducts() async {
    ...
    try {
      final products = await ProductService.getProducts('burger');
      setState(() => _products = products);
    } catch (e) {
      _showError('Erreur lors du chargement des burgers: $e');
    } finally {
  ...
  Future<void> _addProduct() async {
    ...
    try {
      ...
      if (success) {
        _resetForm();
        await _loadProducts();
        _showSuccess('Burger ajouté avec succès');
      } else {
        _showError('Erreur lors de l\'ajout du burger');
      }
    } catch (e) {
      _showError('Erreur: $e');
    } finally {
  ...
  Future<void> _deleteProduct(String id) async {
    ...
    try {
      ...
      if (success) {
        await _loadProducts();
        _showSuccess('Burger supprimé avec succès');
      } else {
      ...
      child: Column(
        ...
        children: [
          ...
          if (_isLoading)
            ...
            const Center(child: Text('Aucun burger disponible'))
          else
            ListView.builder(
              shrinkWrap: true,
